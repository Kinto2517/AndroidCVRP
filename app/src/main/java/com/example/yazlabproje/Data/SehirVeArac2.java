package com.example.yazlabproje.Data;



import com.example.yazlabproje.Algorithm.Araclar;
import com.example.yazlabproje.Algorithm.Depot;
import com.example.yazlabproje.Algorithm.Yolcu;

import java.util.List;

public class SehirVeArac2 {
    ...
    public final static List<Yolcu> Yolcular = List.of(
            new Yolcu("Başiskele", 40.71495046455262, 29.941688470127534, 39),
            new Yolcu("Çayırova", 40.8286176989135, 29.39793387572701, 0),
            new Yolcu("Darıca", 40.77569858837939, 29.37767783324654, 0),
            new Yolcu("Derince", 40.7609035987885, 29.85022723819549, 0),
            new Yolcu("Dilovası", 40.78304288051337, 29.540412776688587, 0),
            new Yolcu("Gebze", 40.79800193051952, 29.450187498288702, 30),
            new Yolcu("Gölcük", 40.712686525190755, 29.84473399031396, 30),
            new Yolcu("Kandıra", 41.06254596888521, 30.15674568391825, 0),
            new Yolcu("Karamürsel", 40.69149108370398, 29.608308371907093, 0),
